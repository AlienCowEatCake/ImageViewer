...
# License: 3-clause BSD License - https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.1185.39/License

include($${PWD}/../../Features.pri)

!disable_msedgewebview2 {

    THIRDPARTY_MSEDGEWEBVIEW2_PATH = $${PWD}/microsoft.web.webview2.1.0.1185.39
