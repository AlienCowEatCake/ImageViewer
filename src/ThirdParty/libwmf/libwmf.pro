...
SOURCES += \
    ...
    $${THIRDPARTY_LIBWMF_PATH}/src/ipa/template.c \
...
# find ./src -name '*.h' | LANG=C sort | sed 's|^\.|    $${THIRDPARTY_LIBWMF_PATH}| ; s|$| \\|'
HEADERS += \
    ...
    $${THIRDPARTY_LIBWMF_PATH}/src/extra/gd/gdhelpers.h \
    $${THIRDPARTY_LIBWMF_PATH}/src/extra/gd/jisx0208.h \
    $${THIRDPARTY_LIBWMF_PATH}/src/extra/gd/wbmp.h \
    ...
    $${THIRDPARTY_LIBWMF_PATH}/src/ipa/template.h \
