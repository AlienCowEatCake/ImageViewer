...
# License: LibTiff License - https://gitlab.com/libtiff/libtiff/blob/master/LICENSE.md
...
THIRDPARTY_LIBTIFF_PATH = $${PWD}/tiff-4.7.2
...
TR_EXCLUDE += $${THIRDPARTY_LIBTIFF_PATH}/* $${THIRDPARTY_LIBTIFF_CONFIG_PATH}/*
