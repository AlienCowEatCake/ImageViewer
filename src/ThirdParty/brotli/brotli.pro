...
THIRDPARTY_BROTLI_CONFIG_PATH = $${PWD}/config
...
SOURCES += \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/dec/prefix.c \
    $${THIRDPARTY_BROTLI_PATH}/c/dec/state.c \
\#    $${THIRDPARTY_BROTLI_PATH}/c/dec/static_init.c \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/enc/static_dict_lut.c \
\#    $${THIRDPARTY_BROTLI_PATH}/c/enc/static_init.c \
...
HEADERS += \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/dec/prefix_inc.h \
    $${THIRDPARTY_BROTLI_PATH}/c/dec/state.h \
    $${THIRDPARTY_BROTLI_PATH}/c/dec/static_init.h \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/enc/dictionary_hash_inc.h \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/enc/hash_base.h \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/enc/hash_longest_match64_simd_inc.h \
    $${THIRDPARTY_BROTLI_PATH}/c/enc/hash_longest_match_inc.h \
    $${THIRDPARTY_BROTLI_PATH}/c/enc/hash_longest_match_quickly_inc.h \
    $${THIRDPARTY_BROTLI_PATH}/c/enc/hash_longest_match_simd_inc.h \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/enc/matching_tag_mask.h \
    ...
    $${THIRDPARTY_BROTLI_PATH}/c/enc/static_dict_lut_inc.h \
    $${THIRDPARTY_BROTLI_PATH}/c/enc/static_init.h \
