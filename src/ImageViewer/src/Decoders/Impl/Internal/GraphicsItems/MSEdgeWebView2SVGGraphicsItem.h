...
#if !defined(MS_EDGE_WEBVIEW2_SVG_GRAPHICS_ITEM_H_INCLUDED)
#define MS_EDGE_WEBVIEW2_SVG_GRAPHICS_ITEM_H_INCLUDED
...
class MSEdgeWebView2SVGGraphicsItem :
        public QObject,
        public QGraphicsItem,
        public AbstractSVGWebBrowserNoJS,
        public IGrabImage
{
    Q_OBJECT
//    Q_INTERFACES(QGraphicsItem)
    Q_DISABLE_COPY(MSEdgeWebView2SVGGraphicsItem)
...
private Q_SLOTS:
    void onUpdateCacheRequested(QRect exposedRect, qreal scaleFactor);
...
#endif // MS_EDGE_WEBVIEW2_SVG_GRAPHICS_ITEM_H_INCLUDED
