...
set QTDIR=C:\Qt\5.12.6\msvc2019_static
...
mkdir %BUILDDIR%
cd %BUILDDIR%
qmake -r CONFIG+="release" QTPLUGIN.imageformats="qico qsvg qtiff" CONFIG+="enable_update_checking" DEFINES+="DISABLE_MENU_STYLER" ..\%PROJECT%.pro
nmake
