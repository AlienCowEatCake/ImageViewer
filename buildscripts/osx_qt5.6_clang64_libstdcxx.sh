...
cd "${BUILDDIR}"
BUILD_PATH="${PWD}"
arch -x86_64 ${CMD_QMAKE} -r CONFIG+="release" LIBS+=-dead_strip QMAKE_MAC_SDK=${MAC_SDK} CONFIG+="disable_cxx11" CONFIG+="enable_macwebview enable_macwkwebview enable_nanosvg" ${QMAKE_EXTRA_ARGS} "../${PROJECT}.pro"
