#!/bin/bash -e
PROJECT=ImageViewer
BUILDDIR=build_osx_qt5.12_clang64_target10.10
APPNAME="Image Viewer"
DMGNAME="${PROJECT}_qt5.12_clang64_target10.10"
...
cd "${BUILDDIR}"
BUILD_PATH="${PWD}"
${CMD_QMAKE} -r CONFIG+="release" LIBS+=-dead_strip QMAKE_MAC_SDK=${MAC_SDK} QMAKE_MACOSX_DEPLOYMENT_TARGET=10.10 CONFIG+=c++1z CONFIG+="enable_update_checking" "../${PROJECT}.pro"
make -j3
cd "${OUT_PATH}"
