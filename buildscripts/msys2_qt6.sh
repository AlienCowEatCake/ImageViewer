...
pacman -S --needed --noconfirm \
    ...
    ${MSYSTEM_PKG_PREFIX}-qt6-tools \
    ${MSYSTEM_PKG_PREFIX}-qt6-base \
    ${MSYSTEM_PKG_PREFIX}-qt6-svg \
    ${MSYSTEM_PKG_PREFIX}-qt6-imageformats \
    ${MSYSTEM_PKG_PREFIX}-qt6-translations \
